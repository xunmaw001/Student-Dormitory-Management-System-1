...
<body style="background-image:url('/xueshengsusheguanli/img/back-img-bg.jpg') !important;background-size:cover;">
<!-- Pre Loader -->
<div class="loading">
    <div class="spinner">
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="register">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    <label>宿管姓名</label>
                                    <input id="suguanName" name="suguanName" class="form-control"
                                           placeholder="宿管姓名">
                                </div>
                                <div class="form-group col-md-12">
                                    <label>宿管手机号</label>
                                    <input id="suguanPhone" name="suguanPhone" class="form-control"
                                   ...
                                   <div class="form-group col-md-12">
                                       <label>楼宇</label>
                                       <select id="louyuTypesSelect" name="louyuTypes" class="form-control">
                                       </select>
                                   </div>
                                <div class="form-group col-md-12">
                                    <label>电子邮箱</label>
                                    <input id="suguanEmail" name="suguanEmail" class="form-control"
                                           placeholder="电子邮箱">
                                </div>
                                <div class="form-group col-md-12">
    ...
    <script>
        ...
        function submit() {
            ...
            if (validform() == true && compare() == true) {
                ...
                var urlParam;
                var successMes = '';
                httpJson("suguan/register", "POST", data, (res) => {
                    if(res.code == 0){
